...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        Dim a As String
        a = "select cid as CaseId,uid as UserId,type,description,crimedate,location,isnull(status,'Pending') as Status,isnull(solution,'Pending') as Solution from casetable where status is null and solution is null order by cid desc"
        'Response.Write(a)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim a As String
        a = "update casetable set status='" & DropDownList1.SelectedValue & "' where cid=" & TextBox1.Text
        'Response.Write(a)
        con = New SqlConnection
        con.ConnectionString = "server=vb;database=crimemgm;uid=project;pwd=project"
        con.Open()
