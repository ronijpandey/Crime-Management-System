...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        Dim a As String
        a = "select cid as CaseId,uid as UserId,type,description,crimedate,location,isnull(status,'Pending') as Status,isnull(solution,'Pending') as Solution from casetable where status='Solved' order by cid desc"
        'Response.Write(a)
