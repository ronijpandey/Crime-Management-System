<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Solved.aspx.vb" Inherits="project.Solved"%>
	...
	<body background="blueline.jpg" MS_POSITIONING="GridLayout">
		<div id="menu">
			<ul>
				...
				<li>
					<A class="active" href="Solved.aspx">Solved Cases</A>
				</li>
				<li>
		...
		<form id="Form1" method="post" runat="server">
			...
			<asp:datagrid id="DataGrid1" style="Z-INDEX: 110; LEFT: 24px; POSITION: absolute; TOP: 168px"
			...
			<asp:Button id="Button2" style="Z-INDEX: 109; LEFT: 976px; POSITION: absolute; TOP: 368px" runat="server"
