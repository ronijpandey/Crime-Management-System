<%@ Page Language="vb" AutoEventWireup="false" Codebehind="OnGoing.aspx.vb" Inherits="project.OnGoing"%>
	...
	<body background="blueline.jpg" MS_POSITIONING="GridLayout">
		<div id="menu">
			<ul>
				...
				<li>
					<A class="active" href="OnGoing.aspx">Ongoing Cases</A>
				</li>
				<li>
		...
		<form id="Form1" method="post" runat="server">
			<asp:hyperlink id="HyperLink1" style="Z-INDEX: 100; LEFT: 1112px; POSITION: absolute; TOP: 88px"
				runat="server" NavigateUrl="CrimalRecord.aspx" BackColor="#FFFFC0">Show Criminal Records</asp:hyperlink>
			<asp:datagrid id="DataGrid1" style="Z-INDEX: 110; LEFT: 24px; POSITION: absolute; TOP: 176px"
				runat="server" Width="809px" Height="184px" HorizontalAlign="Justify" BorderStyle="Solid"
			...
			<asp:Button id="Button2" style="Z-INDEX: 109; LEFT: 992px; POSITION: absolute; TOP: 368px" runat="server"
				BackColor="#8080FF" Font-Bold="True" Text="Update Solution"></asp:Button>
			<asp:Label id="Label2" style="Z-INDEX: 108; LEFT: 952px; POSITION: absolute; TOP: 320px" runat="server"
			...
			<asp:Label id="Label1" style="Z-INDEX: 104; LEFT: 944px; POSITION: absolute; TOP: 168px" runat="server"
				BackColor="#FF8080" Font-Bold="True">Case_ID</asp:Label>
			<asp:DropDownList id="DropDownList2" style="Z-INDEX: 103; LEFT: 1016px; POSITION: absolute; TOP: 208px"
			...
			<asp:TextBox id="TextBox2" style="Z-INDEX: 107; LEFT: 1032px; POSITION: absolute; TOP: 320px"
				runat="server"></asp:TextBox>
			<asp:Image id="Image1" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				Width="520px" Height="96px" ImageUrl="crimes-and-punishment.jpg"></asp:Image></form>
	</body>
</HTML>
